					<?php
	 				...
	 				<?php $query_yes = mysqli_query($GLOBALS["___mysqli_ston"], "select * from teacher_class_student
		            ...
		            ?>
					<?php $query_no = mysqli_query($GLOBALS["___mysqli_ston"], "select * from notification 
