                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
									...
									mysqli_query($GLOBALS["___mysqli_ston"], "update teacher_class_announcements  set content = '$content' where teacher_class_announcements_id = '$id' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
									?>
									<script>
