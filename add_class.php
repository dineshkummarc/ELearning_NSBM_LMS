                            ...
                            <div class="block-content collapse in">
								...
								<form method="post" id="add_class">
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            ...
                                            <select name="class_id"  class="" required>
                                             	<option></option>
											<?php
											$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from class order by class_name");
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="subject_id"  class="" required>
                                             	<option></option>
											<?php
											$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from subject order by subject_code");
											while($row = mysqli_fetch_array($query)){
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
											<?php
											$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from school_year order by school_year DESC");
