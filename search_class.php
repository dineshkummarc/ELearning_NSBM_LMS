            ...
            <div class="row-fluid">
                ...
                <div class="span6" id="content">
                     <div class="row-fluid">
						...
						$school_year_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from school_year where  school_year = '$sy'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										where teacher_id = '$session_id' and school_year = '$school_year' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
