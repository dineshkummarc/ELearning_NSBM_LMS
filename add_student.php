                        ...
                        <div id="block_bg" class="block">
						 ...
						 <thead>
                            ...
                            <tbody>
										...
										$a = 0 ;
										$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from student LEFT JOIN class on class.class_id = student.class_id
...
if (isset($_POST['submit'])){
	...
	$Add = $_POST[$test4];
 	...
 	$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from teacher_class_student where student_id = '$id' and teacher_class_id = '$class_id' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "insert into teacher_class_student (student_id,teacher_class_id,teacher_id) values('$id','$class_id','$teacher_id') ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
