       ...
       <a href="teachers.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Teacher</a>
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<!--
									...
									-->	
									<?php
									$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from teacher where teacher_id = '$get_id' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
									...
									?>
                                          ...
                                          <div class="controls">
											...
											<?php
											$query_teacher = mysqli_query($GLOBALS["___mysqli_ston"], "select * from teacher join  department")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
											...
											<?php
											$department = mysqli_query($GLOBALS["___mysqli_ston"], "select * from department order by department_name");
				   ...
				   <?php
                            if (isset($_POST['update'])) {
								...
								mysqli_query($GLOBALS["___mysqli_ston"], "update teacher set firstname = '$firstname' , lastname = '$lastname' , department_id = '$department_id' where teacher_id = '$get_id' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));	
