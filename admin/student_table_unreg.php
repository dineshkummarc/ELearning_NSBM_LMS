	...
	<?php include('modal_delete.php'); ?>
		...
		<?php
	$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from student LEFT JOIN class ON student.class_id = class.class_id where status = 'Unregistered' ORDER BY student.student_id DESC") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
