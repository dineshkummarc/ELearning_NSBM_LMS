<?php
		...
		/* teacher */
		$query_teacher = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM teacher WHERE username='$username' AND password='$password'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
