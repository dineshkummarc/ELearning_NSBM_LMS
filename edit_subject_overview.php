					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php 
								$subject_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from class_subject_overview where  class_subject_overview_id  = '$subject_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								?>
										...
										mysqli_query($GLOBALS["___mysqli_ston"], "update class_subject_overview set content = '$content' where class_subject_overview_id = '$subject_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
										?>
										<script>
