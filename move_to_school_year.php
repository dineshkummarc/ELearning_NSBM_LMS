					...
					<div class="modal-body">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            ...
                                            <option></option>
											<?php
											$query1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from teacher_class where class_id ='$class_id' and school_year != '$school_year'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
